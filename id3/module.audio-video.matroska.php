													...
													case EBML_ID_VIDEO:
														...
														if ((@$track_entry[$this->EBMLidName(EBML_ID_CODECID)] == 'V_MS/VFW/FOURCC') && isset($track_entry[$this->EBMLidName(EBML_ID_CODECPRIVATE)])) {
															if (getid3_lib::IncludeDependency(GETID3_INCLUDEPATH.'module.audio-video.riff.php', __FILE__, false)) {
																...
																$this->warnings[] = 'Unable to parse codec private data['.__LINE__.'] because cannot include "../getid3/module.audio-video.riff.php"';
															}
														}
														break;
													case EBML_ID_AUDIO:
						...
						switch (@$trackarray[$this->EBMLidName(EBML_ID_CODECID)]) {
							...
							case 'A_AC3':
								if (getid3_lib::IncludeDependency(GETID3_INCLUDEPATH.'module.audio.ac3.php', __FILE__, false)) {
									...
									$this->warnings[] = 'Unable to parse audio data['.__LINE__.'] because cannot include "../getid3/module.audio.ac3.php"';
								}
								break;
							...
							case 'A_DTS':
								...
								if (getid3_lib::IncludeDependency(GETID3_INCLUDEPATH.'module.audio.dts.php', __FILE__, false)) {
									...
									$this->warnings[] = 'Unable to parse audio data['.__LINE__.'] because cannot include "../getid3/module.audio.dts.php"';
								}
								break;
							...
							//		unset($getid3_aac);
							//	} else {
							//		$this->warnings[] = 'Unable to parse audio data['.__LINE__.'] because cannot include "../getid3/module.audio.aac.php"';
							//	}
							//	break;
							...
							case 'A_MPEG/L3':
								if (getid3_lib::IncludeDependency(GETID3_INCLUDEPATH.'module.audio.mp3.php', __FILE__, false)) {
									...
									$this->warnings[] = 'Unable to parse audio data['.__LINE__.'] because cannot include "../getid3/module.audio.mp3.php"';
								}
								break;
								...
								if (isset($trackarray['CodecPrivate'])) {
									...
									if ($found_vorbis) {
										if (getid3_lib::IncludeDependency(GETID3_INCLUDEPATH.'module.audio.ogg.php', __FILE__, false)) {
											...
											$this->warnings[] = 'Unable to parse audio data['.__LINE__.'] because cannot include "../getid3/module.audio.ogg.php"';
										}
									} else {
									}
								} else {
